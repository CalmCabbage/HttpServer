...
/*网站的根目录*/
const char*doc_root="/home/cnic/Documents/linuxC/threadpool/root";
...
http_conn::HTTP_CODE http_conn::do_request()
{
    ...
    if (strcmp(m_url, "/") == 0)
        strncpy(m_real_file+len, index, FILENAME_LEN-len-1);
    else
...
void http_conn::init_mmap() {
    m_file_fd = open(m_real_file, O_RDONLY);
    fstat(m_file_fd, &m_file_stat);
...
{
    return add_response("Content-Type:%s;%s\r\n", "text/html", "charset=UTF-8");
}
